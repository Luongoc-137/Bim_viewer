...
Tệp ````index.json```` ở thư mục gốc của ````./app/data/projects```` được hiển thị bên dưới.

Trong tệp này, ````id```` của mỗi dự án khớp với tên thư mục con của dự án đó.
...
| "saoKernelRadius"      | Number  | ````[0.0...200.0]````  | ````100.0````         | Diện tích tối đa mà SAO tính đến khi kiểm tra khả năng bị che khuất                                                                                                                                                                                                                              |
| "saoBlur"              | Boolean |                        | ````true````          | Có bật làm mờ Gaussian cho SAO hay không                                                                                                                                                                                                                                                                       |
| "edgesEnabled"         | Boolean |                        | ````true````          | Có tăng cường các cạnh trên đối tượng hay không                                                                                                                                                                                                                                                                     |
| "pbrEnabled"           | Boolean |                        | ````false````         | Có bật kết xuất Dựa trên Vật lý (PBR) hay không                                                                                                                                                                                                                                                      |
| "viewFitFOV"           | Number  | ````[10.0...70.0]````  | ````30````            | Khi khớp các đối tượng với chế độ xem, đây là số độ mà chúng nên khớp với trường nhìn của người dùng                                                                                                                                                                                               |
| "viewFitDuration"      | Number  | ````[0..5]````         | ````0.5````           | Khi khớp các đối tượng với chế độ xem với chuyển cảnh động, đây là thời lượng chuyển cảnh tính bằng giây                                                                                                                                                                                                    |
| "perspectiveFOV"       | Number  | ````[10.0...70.0]````  | ````55````            | Khi ở chế độ chiếu phối cảnh, đây là trường nhìn, tính bằng độ, mà người dùng nhìn thấy                                                                                                                                                                                                                      |
| "objectColors"         | Object  |                        | ````undefined````     | Bản đồ các thuộc tính tùy chỉnh cho các loại IFC khác nhau                                                                                                                                                                                                                                                               |
| "externalMetadata"     | Boolean |                        | ````false````         | Có tải tệp metadata.json cùng với mỗi tệp geometry.xkt hay không                                                                                                                                                                                                                                               |
| "xrayPickable"         | Boolean |                        | ````false````         | Có thể tương tác với các đối tượng bị X-quang bằng đầu vào chuột/cảm ứng hay không                                                                                                                                                                                                                                           |
| "selectedGlowThrough"  | Boolean |                        | ````true````          | Các đối tượng được chọn có xuất hiện "phát sáng xuyên qua" các đối tượng khác hay không                                                                                                                                                                                                                                |
| "highlightGlowThrough" | Boolean |                        | ````true````          | Các đối tượng được đánh dấu có xuất hiện "phát sáng xuyên qua" các đối tượng khác hay không                                                                                                                                                                                                                             |
| "dtxEnabled"           | Boolean |                        | ````false````         | Có bật chế độ biểu diễn và kết xuất cảnh dựa trên kết cấu dữ liệu (DTX) của xeokit hay không. Chế độ này có dung lượng bộ nhớ thấp hơn chế độ dựa trên đối tượng bộ đệm đỉnh (VBO) tiêu chuẩn, và tải nhanh, nhưng có thể chậm hơn trên GPU cấu hình thấp.                                                                    |
| "showSpaces"           | Boolean |                        | ````false````         | Có bật hiển thị các phần tử IfcSpace hay không. Khi giá trị này là ````false````, thì dù chúng ta có thể hướng dẫn BIMViewer làm cho IfcSpaces hiển thị trong chế độ xem cây hoặc menu ngữ cảnh, chúng vẫn sẽ ẩn. Cấu hình này cũng được điều khiển động bởi công cụ "Show IfcSpaces" trên thanh công cụ. |
...
| "expandObjectsTree"   | Number            |  [0..*]               | 0                 | Độ sâu mở rộng cây "objects" |
| "expandClassesTree"   | Number            |  [0..*]               | 0                 | Độ sâu mở rộng cây "classes" |
| "expandStoreysTree"   | Number            |  [0..*]               | 0                 | Độ sâu mở rộng cây "storeys" |
...
Để BIMViewer tải cả tệp ````geometry.xkt```` và ````metadata.json```` cho mỗi mô hình, chúng ta cần thêm
cấu hình ````externalMetadata: true```` mới vào ````viewerConfigs```` trong tệp ````index.json```` của dự án:
